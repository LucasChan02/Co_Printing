...
echo_and_run cd "/home/ubuntu/armpi_pro/src/armpi_pro_kinematics"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/ubuntu/armpi_pro/src/armpi_pro_kinematics/setup.py" \
     \
    build --build-base "/home/ubuntu/armpi_pro/build/armpi_pro_kinematics" \
    install \
    --root="${DESTDIR-/}" \
