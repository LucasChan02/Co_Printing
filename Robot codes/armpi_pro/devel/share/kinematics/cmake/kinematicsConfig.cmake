...
if("TRUE" STREQUAL "TRUE")
  set(kinematics_SOURCE_PREFIX /home/ubuntu/armpi_pro/src/armpi_pro_kinematics)
  set(kinematics_DEVEL_PREFIX /home/ubuntu/armpi_pro/devel)
  ...
  set(kinematics_INSTALL_PREFIX /home/ubuntu/armpi_pro/install)
...
if(NOT " " STREQUAL " ")
  ...
  elseif(NOT " " STREQUAL " ")
    ...
    set(_report "Report the problem to the maintainer 'lucas <hchen262@uic.edu>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'kinematics' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/ubuntu/armpi_pro/src/armpi_pro_kinematics/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/ubuntu/armpi_pro/devel/lib;/home/ubuntu/armpi_pro/devel/lib;/opt/ros/melodic/lib)
