...
if __name__ == '__main__':
    ...
    while start:
        ...
        set_velocity.publish(80,270,0) # Linear speed: 60，Directional Angle: 90 ，Yaw speed: 0 (Less than 0 is CCW)
        target = ik.setPitchRanges((0.0, 0.20, 0.20), -90, -180, 0) # Kinematics solution
        if target: # Determine if there is a solution
            servo_data = target[1]
            # Move the arm
