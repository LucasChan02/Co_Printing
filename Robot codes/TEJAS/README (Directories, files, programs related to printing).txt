For access to all files mentioned below, go to ubuntu----> Files-----> armpi_pro
...
5.Replace codes which use pandas as pd with other library functions used in python for robot 2. Robot 1 has pandas inbuilt in the system.
